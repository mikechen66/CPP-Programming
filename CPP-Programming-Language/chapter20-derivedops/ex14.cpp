...
void run_test(derivedops::complfunc cmp, const char* func_name) {
    using namespace std;
...
int main() {
    ...
    run_test(&derivedops::complete_name, "complete_name");
    run_test(&derivedops::complete_name2, "complete_name2");
    run_test(&derivedops::complete_name3, "complete_name3");
    run_test(&derivedops::complete_name_fast, "complete_name_fast");
}
...
$g++ -o main *.cpp
$main
complete_name: 55494500
complete_name2: 75208454
complete_name3: 54147447
complete_name_fast: 42183813
 */
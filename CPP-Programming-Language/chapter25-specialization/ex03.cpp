...
int main() {
    ...
    cout << "String2 with virtuals: " << measure<specialization::String2>() << endl; // A little slower, but not remarkably so.
}
...
$g++ -o main *.cpp
$main
Standard string: 23763110
String2 with virtuals: 30352470
 */
...
int main() {
    ...
    runtime::valarray<double> x(arr1, 5);
    runtime::valarray<double> y(arr2, 5);
    runtime::valarray<double> z(arr3, 5);

    x = 0.5 * (x + y) + z;
    cout << x << endl; // [ 2.5 4.5 3.5 5.5 4.5]

    cout << "Small valarray (custom): " << test_small<runtime::valarray<double> >() << endl;
    cout << "Small valarray (std): " << test_small<std::valarray<double> >() << endl;
    cout << "Large valarray (custom): " << test_large<runtime::valarray<double> >() << endl;
...
$main
[ 2.5 4.5 3.5 5.5 4.5 ]
Small valarray (custom): 59770421
Small valarray (std): 34993187
Large valarray (custom): 3733999147
Large valarray (std): 3814982056
 */
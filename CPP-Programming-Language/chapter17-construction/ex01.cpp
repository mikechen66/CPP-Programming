...
$g++ -o main *.cpp
$main
vector of 1m, initial fill: 76801422
vector of 1m, back insert O(1): 517
vector of 1m, front insert O(n): 262120
vector of 1m, erase middle O(n): 136313
list of 1m, initial fill: 154147307
list of 1m, back insert O(1): 319
list of 1m, front insert O(1): 706
list of 1m, erase middle - includes time to find middle O(n): 3045193
deque of 1m, initial fill: 43107983
deque of 1m, back insert O(1): 199
deque of 1m, front insert O(n): 584
deque of 1m, erase middle O(n): 1099394
map of 1m, initial fill): 1371197941
map of 1m, add high value O(log n): 12145
map of 1m, modify medium value O(log n): 4715
map of 1m, modify low value O(log n): 1478
map of 1m, erase middle - includes time to find middle O(n): 14016342
 */
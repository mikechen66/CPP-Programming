...
int main() {
    ...
    for_each(v.begin(), v.end(), overloading::mem_fun(&Test::no_args));
    for_each(v.begin(), v.end(), bind2nd(overloading::mem_fun(&Test::one_arg), 4));
    for_each(v.begin(), v.end(), overloading::mem_fun(&Test::const_no_args));
    for_each(v.begin(), v.end(), bind2nd(overloading::mem_fun(&Test::const_one_arg), 4));
    ...
    for_each(v1.begin(), v1.end(), overloading::mem_fun_ref(&Test::no_args));
    for_each(v1.begin(), v1.end(), bind2nd(overloading::mem_fun_ref(&Test::one_arg), 5));
    for_each(v1.begin(), v1.end(), overloading::mem_fun_ref(&Test::const_no_args));
    for_each(v1.begin(), v1.end(), bind2nd(overloading::mem_fun_ref(&Test::const_one_arg), 5));
}
...
one_args called: 2 (4)
one_args called: 3 (4)
const_no_args called: 1
const_no_args called: 2
const_no_args called: 3
const_one_args called: 1 (4)
const_one_args called: 2 (4)
const_one_args called: 3 (4)
no_args called: 1
no_args called: 2
no_args called: 3
one_args called: 1 (5)
...
const_no_args called: 2
const_no_args called: 3
const_one_args called: 1 (5)
const_one_args called: 2 (5)
const_one_args called: 3 (5)
 */